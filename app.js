...
function migrateState(s) {
  ...
  // Roster reduzido (v1.68+) — só 4 lutadores. Se o user tinha
  // marklee/jeno/dhano/matthew/joonki como ativo, limpa pra forçar reseleção.
  const VALID_CHARS = new Set(['yeonjun', 'cagemorgan', 'sanji', 'joehigashi']);
