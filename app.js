...
const FOOD_DB = [
  ...
  // ===== Lasanhas, canelones, escondidinhos (gratinados) =====
  { name: 'Lasanha de frango ao molho branco (200g)', kcal: 380, p: 24,   c: 32,   f: 18,   cat: 'prato' },
  { name: 'Lasanha bolonhesa (200g)',          kcal: 350, p: 18,   c: 35,   f: 15,   cat: 'prato' },
  { name: 'Lasanha 4 queijos (200g)',          kcal: 410, p: 17,   c: 28,   f: 26,   cat: 'prato' },
  { name: 'Lasanha de berinjela (200g)',       kcal: 220, p: 12,   c: 18,   f: 11,   cat: 'prato' },
  { name: 'Lasanha de presunto e queijo (200g)', kcal: 380, p: 20,   c: 30,   f: 20,   cat: 'prato' },
  { name: 'Lasanha vegetariana (200g)',        kcal: 260, p: 11,   c: 30,   f: 11,   cat: 'prato' },
  { name: 'Canelone de frango ao branco (2un)', kcal: 320, p: 22,   c: 30,   f: 13,   cat: 'prato' },
  { name: 'Canelone presunto e queijo (2un)',  kcal: 340, p: 18,   c: 32,   f: 16,   cat: 'prato' },
  { name: 'Rondelli ao sugo (2un)',            kcal: 290, p: 15,   c: 30,   f: 12,   cat: 'prato' },
  { name: 'Capeletti ao molho branco (200g)',  kcal: 360, p: 14,   c: 38,   f: 16,   cat: 'prato' },
  { name: 'Gratinado de batata e queijo (200g)', kcal: 280, p: 9,    c: 32,   f: 12,   cat: 'prato' },
  { name: 'Escondidinho de carne seca (200g)', kcal: 350, p: 18,   c: 35,   f: 14,   cat: 'prato' },
  { name: 'Escondidinho de frango (200g)',     kcal: 320, p: 22,   c: 32,   f: 11,   cat: 'prato' },
  { name: 'Escondidinho de camarão (200g)',    kcal: 360, p: 20,   c: 34,   f: 14,   cat: 'prato' },
  { name: 'Bolo de carne (1 fatia 150g)',      kcal: 320, p: 22,   c: 12,   f: 20,   cat: 'prato' },
  { name: 'Rocambole de carne moída (150g)',   kcal: 320, p: 18,   c: 22,   f: 18,   cat: 'prato' },

  // ===== Doces brasileiros tradicionais =====
  { name: 'Beijinho (1un)',                    kcal: 70,  p: 1,    c: 12,   f: 2.5,  cat: 'doce' },
  { name: 'Beijinho gourmet (1un grande)',     kcal: 110, p: 2,    c: 18,   f: 4,    cat: 'doce' },
  { name: 'Brigadeiro (1un)',                  kcal: 80,  p: 1,    c: 13,   f: 3,    cat: 'doce' },
  { name: 'Brigadeiro gourmet (1un grande)',   kcal: 130, p: 2,    c: 20,   f: 5,    cat: 'doce' },
  { name: 'Brigadeirão (fatia 100g)',          kcal: 280, p: 5,    c: 35,   f: 14,   cat: 'doce' },
  { name: 'Cajuzinho (1un)',                   kcal: 90,  p: 2,    c: 12,   f: 4,    cat: 'doce' },
  { name: 'Olho de sogra (1un)',               kcal: 85,  p: 1,    c: 14,   f: 3,    cat: 'doce' },
  { name: 'Camafeu (1un)',                     kcal: 95,  p: 2,    c: 12,   f: 5,    cat: 'doce' },
  { name: 'Surpresa de uva (1un)',             kcal: 75,  p: 1,    c: 14,   f: 2,    cat: 'doce' },
  { name: 'Bem-casado (1un)',                  kcal: 180, p: 3,    c: 26,   f: 7,    cat: 'doce' },
  { name: 'Casadinho (1un)',                   kcal: 130, p: 2,    c: 20,   f: 5,    cat: 'doce' },
  { name: 'Pé de moleque (1un)',               kcal: 130, p: 4,    c: 17,   f: 6,    cat: 'doce' },
  { name: 'Paçoca rolha (1un)',                kcal: 90,  p: 3,    c: 11,   f: 4,    cat: 'doce' },
  { name: 'Cocada branca (50g)',               kcal: 200, p: 2,    c: 30,   f: 8,    cat: 'doce' },
  { name: 'Cocada de forno (1un)',             kcal: 150, p: 2,    c: 22,   f: 6,    cat: 'doce' },
  { name: 'Cocada queimada (50g)',             kcal: 210, p: 2,    c: 32,   f: 9,    cat: 'doce' },
  { name: 'Quindim (1un)',                     kcal: 200, p: 4,    c: 28,   f: 9,    cat: 'doce' },
  { name: 'Manjar de coco (100g)',             kcal: 230, p: 4,    c: 32,   f: 10,   cat: 'doce' },
  { name: 'Pudim de leite condensado (100g)',  kcal: 220, p: 6,    c: 32,   f: 9,    cat: 'doce' },
  { name: 'Pudim de pão (100g)',               kcal: 200, p: 6,    c: 30,   f: 7,    cat: 'doce' },
  { name: 'Goiabada cremosa (50g)',            kcal: 130, p: 0,    c: 33,   f: 0,    cat: 'doce' },
  { name: 'Romeu e Julieta (50g goiabada + 50g queijo)', kcal: 280, p: 9,    c: 35,   f: 12,   cat: 'doce' },
  { name: 'Doce de leite Viçosa (1col sopa)',  kcal: 80,  p: 2,    c: 14,   f: 1.5,  cat: 'doce' },
  { name: 'Doce de abóbora com coco (100g)',   kcal: 210, p: 2,    c: 40,   f: 5,    cat: 'doce' },
  { name: 'Doce de batata doce (100g)',        kcal: 180, p: 2,    c: 38,   f: 2,    cat: 'doce' },
  { name: 'Doce de mamão verde (100g)',        kcal: 200, p: 1,    c: 50,   f: 0.3,  cat: 'doce' },
  { name: 'Curau (200g)',                      kcal: 240, p: 6,    c: 38,   f: 7,    cat: 'doce' },
  { name: 'Pamonha doce (1un)',                kcal: 320, p: 6,    c: 50,   f: 10,   cat: 'doce' },
  { name: 'Canjica (200g)',                    kcal: 250, p: 6,    c: 42,   f: 6,    cat: 'doce' },
  { name: 'Arroz doce (200g)',                 kcal: 270, p: 6,    c: 45,   f: 7,    cat: 'doce' },
  { name: 'Mousse de maracujá (100g)',         kcal: 180, p: 4,    c: 25,   f: 7,    cat: 'doce' },
  { name: 'Mousse de limão (100g)',            kcal: 170, p: 3,    c: 24,   f: 7,    cat: 'doce' },
  { name: 'Mousse de chocolate (100g)',        kcal: 220, p: 4,    c: 26,   f: 11,   cat: 'doce' },
  { name: 'Mousse de morango (100g)',          kcal: 190, p: 4,    c: 25,   f: 8,    cat: 'doce' },
  { name: 'Pavê de chocolate (200g)',          kcal: 380, p: 6,    c: 45,   f: 18,   cat: 'doce' },
  { name: 'Pavê de bombom Sonho de Valsa (200g)', kcal: 480, p: 8,    c: 55,   f: 22,   cat: 'doce' },
  { name: 'Petit gâteau c/ sorvete (1un)',     kcal: 480, p: 8,    c: 60,   f: 22,   cat: 'doce' },
  { name: 'Brownie (1un 80g)',                 kcal: 320, p: 4,    c: 38,   f: 18,   cat: 'doce' },
  { name: 'Cheesecake fatia (100g)',           kcal: 320, p: 6,    c: 30,   f: 19,   cat: 'doce' },
  { name: 'Tiramisu (100g)',                   kcal: 290, p: 5,    c: 28,   f: 17,   cat: 'doce' },
  { name: 'Crème brulée (100g)',               kcal: 280, p: 5,    c: 24,   f: 18,   cat: 'doce' },
  { name: 'Macaron (1un)',                     kcal: 80,  p: 1,    c: 12,   f: 3,    cat: 'doce' },
  { name: 'Profiterole (3un)',                 kcal: 320, p: 6,    c: 32,   f: 18,   cat: 'doce' },
  { name: 'Torta holandesa (fatia 150g)',      kcal: 480, p: 7,    c: 55,   f: 25,   cat: 'doce' },
  { name: 'Torta de morango (fatia 150g)',     kcal: 320, p: 5,    c: 45,   f: 13,   cat: 'doce' },
  { name: 'Torta de limão (fatia 150g)',       kcal: 320, p: 5,    c: 38,   f: 16,   cat: 'doce' },

  // ===== Bolachas e biscoitos (marcas BR) =====
  { name: 'Bolacha Mabel água e sal (4un 30g)', kcal: 130, p: 3,    c: 21,   f: 4,    cat: 'erro' },
  { name: 'Bolacha Mabel cream cracker (4un 30g)', kcal: 130, p: 3,    c: 22,   f: 3.5,  cat: 'erro' },
  { name: 'Bolacha Mabel maizena (4un 30g)',   kcal: 140, p: 2.5,  c: 22,   f: 4,    cat: 'erro' },
  { name: 'Bolacha Mabel mesclado doce (4un)', kcal: 160, p: 2,    c: 24,   f: 6,    cat: 'erro' },
  { name: 'Bolacha Mabel recheada chocolate (3un)', kcal: 150, p: 2,    c: 22,   f: 6,    cat: 'erro' },
  { name: 'Bolacha Mabel recheada morango (3un)', kcal: 145, p: 2,    c: 22,   f: 5.5,  cat: 'erro' },
  { name: 'Bolacha rosquinha de coco (5un)',   kcal: 170, p: 2,    c: 28,   f: 6,    cat: 'erro' },
  { name: 'Bolacha Maria (5un)',               kcal: 120, p: 2,    c: 22,   f: 3,    cat: 'erro' },
  { name: 'Trakinas chocolate (3un)',          kcal: 145, p: 1.5,  c: 21,   f: 6,    cat: 'erro' },
  { name: 'Trakinas morango (3un)',            kcal: 140, p: 1.5,  c: 21,   f: 6,    cat: 'erro' },
  { name: 'Bono chocolate (3un)',              kcal: 145, p: 2,    c: 21,   f: 6,    cat: 'erro' },
  { name: 'Bono morango (3un)',                kcal: 140, p: 2,    c: 21,   f: 6,    cat: 'erro' },
  { name: 'Negresco (2un)',                    kcal: 100, p: 1,    c: 14,   f: 4.5,  cat: 'erro' },
  { name: 'Negresco recheio duplo (2un)',      kcal: 130, p: 1,    c: 17,   f: 6,    cat: 'erro' },
  { name: 'Passatempo recheado (3un)',         kcal: 160, p: 2,    c: 23,   f: 7,    cat: 'erro' },
  { name: 'Cream cracker Adria (4un)',         kcal: 130, p: 3,    c: 21,   f: 3.5,  cat: 'erro' },
  { name: 'Belvita morning bauducco (1 pacote)', kcal: 230, p: 3,    c: 35,   f: 9,    cat: 'erro' },
  { name: 'Club Social original (1 sache 6un)', kcal: 105, p: 2,    c: 13,   f: 4.5,  cat: 'erro' },
  { name: 'Club Social integral (1 sache)',    kcal: 100, p: 2.5,  c: 14,   f: 4,    cat: 'erro' },
  { name: 'Wafer Mirabel chocolate (3un)',     kcal: 145, p: 1,    c: 21,   f: 6,    cat: 'erro' },
  { name: 'Calipso (1un)',                     kcal: 55,  p: 0,    c: 12,   f: 0.5,  cat: 'erro' },
  { name: 'Tortuguita (1un)',                  kcal: 120, p: 1,    c: 14,   f: 7,    cat: 'erro' },
  { name: 'Bauducco maxi cookie (1un)',        kcal: 200, p: 2,    c: 27,   f: 9,    cat: 'erro' },
  { name: 'Cookies caseiros gotas chocolate (1un 25g)', kcal: 120, p: 2,    c: 16,   f: 6,    cat: 'erro' },

  // ===== Salgados de padaria / lanchonete =====
  { name: 'Coxinha de frango (1un 90g)',       kcal: 230, p: 12,   c: 25,   f: 10,   cat: 'erro' },
  { name: 'Coxinha cremosa Catupiry (1un 100g)', kcal: 280, p: 13,   c: 26,   f: 14,   cat: 'erro' },
  { name: 'Coxinha de jaca (vegana 1un)',      kcal: 200, p: 4,    c: 30,   f: 7,    cat: 'erro' },
  { name: 'Risole de queijo (1un)',            kcal: 180, p: 7,    c: 18,   f: 9,    cat: 'erro' },
  { name: 'Risole de palmito (1un)',           kcal: 170, p: 5,    c: 19,   f: 8,    cat: 'erro' },
  { name: 'Risole de camarão (1un)',           kcal: 190, p: 9,    c: 18,   f: 9,    cat: 'erro' },
  { name: 'Esfiha de carne aberta (1un)',      kcal: 150, p: 7,    c: 16,   f: 6,    cat: 'erro' },
  { name: 'Esfiha de queijo fechada (1un)',    kcal: 220, p: 8,    c: 24,   f: 9,    cat: 'erro' },
  { name: 'Esfiha de frango fechada (1un)',    kcal: 210, p: 11,   c: 22,   f: 8,    cat: 'erro' },
  { name: 'Kibe frito (1un 80g)',              kcal: 240, p: 11,   c: 18,   f: 13,   cat: 'erro' },
  { name: 'Kibe assado (1un 100g)',            kcal: 200, p: 14,   c: 16,   f: 9,    cat: 'erro' },
  { name: 'Kibe cru bandeja (100g)',           kcal: 240, p: 18,   c: 14,   f: 12,   cat: 'erro' },
  { name: 'Pastel de carne (1un)',             kcal: 280, p: 9,    c: 24,   f: 16,   cat: 'erro' },
  { name: 'Pastel de queijo (1un)',            kcal: 270, p: 10,   c: 22,   f: 16,   cat: 'erro' },
  { name: 'Pastel de palmito (1un)',           kcal: 230, p: 5,    c: 23,   f: 13,   cat: 'erro' },
  { name: 'Pastel de pizza (1un)',             kcal: 290, p: 11,   c: 25,   f: 16,   cat: 'erro' },
  { name: 'Pastel de frango com catupiry (1un)', kcal: 300, p: 12,   c: 24,   f: 17,   cat: 'erro' },
  { name: 'Empada de palmito (1un)',           kcal: 240, p: 6,    c: 22,   f: 14,   cat: 'erro' },
  { name: 'Empada de frango (1un)',            kcal: 260, p: 10,   c: 22,   f: 14,   cat: 'erro' },
  { name: 'Empadão de frango caseiro (200g)',  kcal: 380, p: 16,   c: 30,   f: 22,   cat: 'erro' },
  { name: 'Croissant simples (1un)',           kcal: 230, p: 5,    c: 22,   f: 13,   cat: 'erro' },
  { name: 'Croissant de queijo (1un)',         kcal: 280, p: 9,    c: 24,   f: 16,   cat: 'erro' },
  { name: 'Croissant de chocolate (1un)',      kcal: 320, p: 6,    c: 32,   f: 18,   cat: 'erro' },
  { name: 'Pão de queijo Forno de Minas (1un 25g)', kcal: 70,  p: 2,    c: 7,    f: 3.5,  cat: 'erro' },
  { name: 'Pão de queijo padaria grande (1un 60g)', kcal: 180, p: 5,    c: 18,   f: 9,    cat: 'erro' },
  { name: 'Joelho de queijo e presunto (1un)', kcal: 270, p: 12,   c: 28,   f: 11,   cat: 'erro' },
  { name: 'Enroladinho de salsicha (1un)',     kcal: 250, p: 8,    c: 24,   f: 13,   cat: 'erro' },
  { name: 'Bauru de padaria (1un)',            kcal: 350, p: 18,   c: 38,   f: 13,   cat: 'erro' },
  { name: 'Misto quente de padaria (1un)',     kcal: 290, p: 14,   c: 32,   f: 11,   cat: 'erro' },
  { name: 'Americano de padaria (1un)',        kcal: 380, p: 18,   c: 40,   f: 14,   cat: 'erro' },
  { name: 'Pão na chapa com manteiga (1un)',   kcal: 280, p: 6,    c: 36,   f: 11,   cat: 'erro' },
  { name: 'Bolinho de chuva (3un)',            kcal: 180, p: 3,    c: 28,   f: 6,    cat: 'doce' },
  { name: 'Sonho recheado (1un)',              kcal: 380, p: 6,    c: 50,   f: 17,   cat: 'doce' },
  { name: 'Donut polvilhado (1un)',            kcal: 280, p: 4,    c: 38,   f: 13,   cat: 'doce' },
  { name: 'Donut glaceado chocolate (1un)',    kcal: 320, p: 4,    c: 42,   f: 15,   cat: 'doce' },

  // ===== Sushis e japoneses extras =====
  { name: 'Niguiri salmão (1un)',              kcal: 50,  p: 3,    c: 6,    f: 1.5,  cat: 'prato' },
  { name: 'Niguiri atum (1un)',                kcal: 45,  p: 3,    c: 6,    f: 1,    cat: 'prato' },
  { name: 'Hot Filadélfia (4 peças)',          kcal: 360, p: 11,   c: 38,   f: 18,   cat: 'prato' },
  { name: 'Uramaki salmão (4 peças)',          kcal: 220, p: 8,    c: 28,   f: 8,    cat: 'prato' },
  { name: 'Temaki salmão (1un grande)',        kcal: 380, p: 15,   c: 50,   f: 12,   cat: 'prato' },
  { name: 'Temaki salmão skin (1un)',          kcal: 350, p: 12,   c: 45,   f: 13,   cat: 'prato' },
  { name: 'Temaki camarão crocante (1un)',     kcal: 420, p: 14,   c: 50,   f: 17,   cat: 'prato' },
  { name: 'Sashimi salmão (5 peças)',          kcal: 130, p: 18,   c: 0,    f: 6,    cat: 'proteina' },
  { name: 'Sashimi atum (5 peças)',            kcal: 110, p: 22,   c: 0,    f: 2,    cat: 'proteina' },
  { name: 'Yakisoba frango (300g)',            kcal: 580, p: 28,   c: 75,   f: 16,   cat: 'prato' },
  { name: 'Yakisoba carne (300g)',             kcal: 620, p: 28,   c: 72,   f: 20,   cat: 'prato' },
  { name: 'Yakisoba vegetariano (300g)',       kcal: 450, p: 12,   c: 70,   f: 13,   cat: 'prato' },
  { name: 'Lamen tonkotsu (1 tigela 600g)',    kcal: 720, p: 28,   c: 90,   f: 22,   cat: 'prato' },
  { name: 'Lamen shoyu (1 tigela)',            kcal: 580, p: 24,   c: 85,   f: 14,   cat: 'prato' },
  { name: 'Gyoza frito (5un)',                 kcal: 280, p: 11,   c: 25,   f: 14,   cat: 'erro' },
  { name: 'Gyoza cozido (5un)',                kcal: 220, p: 11,   c: 25,   f: 8,    cat: 'prato' },
  { name: 'Karaage frango frito (150g)',       kcal: 380, p: 22,   c: 22,   f: 22,   cat: 'erro' },
  { name: 'Tempura mista (8 peças)',           kcal: 380, p: 12,   c: 38,   f: 18,   cat: 'erro' },
  { name: 'Edamame cozido (100g)',             kcal: 120, p: 11,   c: 10,   f: 5,    cat: 'veg' },
  { name: 'Missoshiru (1 tigela 250ml)',       kcal: 70,  p: 5,    c: 7,    f: 2,    cat: 'prato' },
  { name: 'Onigiri salmão (1un)',              kcal: 180, p: 7,    c: 35,   f: 1.5,  cat: 'prato' },
  { name: 'Onigiri atum maionese (1un)',       kcal: 200, p: 6,    c: 35,   f: 4,    cat: 'prato' },

  // ===== Coreanas =====
  { name: 'Bibimbap (300g)',                   kcal: 580, p: 22,   c: 80,   f: 18,   cat: 'prato' },
  { name: 'Bibimbap com bulgogi (350g)',       kcal: 680, p: 32,   c: 80,   f: 22,   cat: 'prato' },
  { name: 'Bulgogi (200g)',                    kcal: 380, p: 30,   c: 12,   f: 22,   cat: 'proteina' },
  { name: 'Galbi costela coreana (200g)',      kcal: 450, p: 28,   c: 8,    f: 32,   cat: 'proteina' },
  { name: 'Tteokbokki (250g)',                 kcal: 420, p: 8,    c: 70,   f: 11,   cat: 'prato' },
  { name: 'Japchae (200g)',                    kcal: 280, p: 8,    c: 42,   f: 9,    cat: 'prato' },
  { name: 'Mandu coreano frito (5un)',         kcal: 320, p: 14,   c: 32,   f: 14,   cat: 'erro' },
  { name: 'Korean fried chicken (200g)',       kcal: 480, p: 24,   c: 32,   f: 26,   cat: 'erro' },
  { name: 'Hotteok panqueca coreana (1un)',    kcal: 280, p: 4,    c: 42,   f: 10,   cat: 'doce' },
  { name: 'Kimbap (4 peças)',                  kcal: 220, p: 8,    c: 35,   f: 6,    cat: 'prato' },
  { name: 'Soondubu jjigae (250ml)',           kcal: 180, p: 14,   c: 12,   f: 8,    cat: 'prato' },
  { name: 'Soju (1 dose 50ml)',                kcal: 75,  p: 0,    c: 0,    f: 0,    cat: 'bebida' },
  { name: 'Cerveja coreana Cass (350ml)',      kcal: 130, p: 1,    c: 11,   f: 0,    cat: 'bebida' },
  { name: 'Makgeolli coreano (200ml)',         kcal: 100, p: 1,    c: 5,    f: 0,    cat: 'bebida' },

  // ===== Pratos quentes brasileiros =====
  { name: 'Feijão tropeiro (200g)',            kcal: 320, p: 18,   c: 35,   f: 13,   cat: 'prato' },
  { name: 'Tutu de feijão (200g)',             kcal: 280, p: 14,   c: 38,   f: 8,    cat: 'prato' },
  { name: 'Baião de dois (200g)',              kcal: 290, p: 12,   c: 42,   f: 8,    cat: 'prato' },
  { name: 'Arroz carreteiro (300g)',           kcal: 480, p: 22,   c: 60,   f: 15,   cat: 'prato' },
  { name: 'Arroz à grega (200g)',              kcal: 280, p: 5,    c: 50,   f: 6,    cat: 'prato' },
  { name: 'Arroz com brócolis (200g)',         kcal: 220, p: 5,    c: 42,   f: 3,    cat: 'prato' },
  { name: 'Estrogonofe de frango (200g)',      kcal: 320, p: 22,   c: 12,   f: 20,   cat: 'prato' },
  { name: 'Estrogonofe de carne (200g)',       kcal: 350, p: 22,   c: 12,   f: 23,   cat: 'prato' },
  { name: 'Frango xadrez (200g)',              kcal: 280, p: 24,   c: 18,   f: 11,   cat: 'prato' },
  { name: 'Frango à passarinho (200g)',        kcal: 380, p: 26,   c: 5,    f: 28,   cat: 'erro' },
  { name: 'Frango à parmegiana (1 filé 150g)', kcal: 380, p: 28,   c: 22,   f: 18,   cat: 'prato' },
  { name: 'Frango à milanesa (1 filé)',        kcal: 320, p: 28,   c: 18,   f: 15,   cat: 'prato' },
  { name: 'Picanha grelhada (150g)',           kcal: 340, p: 28,   c: 0,    f: 24,   cat: 'proteina' },
  { name: 'Maminha grelhada (150g)',           kcal: 280, p: 30,   c: 0,    f: 17,   cat: 'proteina' },
  { name: 'Costela bovina assada (200g)',      kcal: 480, p: 28,   c: 0,    f: 40,   cat: 'proteina' },
  { name: 'Linguiça toscana grelhada (100g)',  kcal: 290, p: 14,   c: 1,    f: 25,   cat: 'proteina' },
  { name: 'Bife à milanesa (1 filé 150g)',     kcal: 380, p: 28,   c: 22,   f: 18,   cat: 'prato' },
  { name: 'Bife à cavalo (1 filé + 1 ovo)',    kcal: 420, p: 32,   c: 1,    f: 30,   cat: 'prato' },
  { name: 'Filé de tilápia grelhado (150g)',   kcal: 175, p: 30,   c: 0,    f: 5,    cat: 'proteina' },
  { name: 'Filé de salmão grelhado (150g)',    kcal: 320, p: 28,   c: 0,    f: 22,   cat: 'proteina' },
  { name: 'Atum em lata em óleo (1 lata 170g)', kcal: 380, p: 35,   c: 0,    f: 24,   cat: 'proteina' },
  { name: 'Atum em lata em água (1 lata 170g)', kcal: 200, p: 45,   c: 0,    f: 1.5,  cat: 'proteina' },
  { name: 'Bobó de camarão (250g)',            kcal: 380, p: 22,   c: 28,   f: 18,   cat: 'prato' },
  { name: 'Moqueca de peixe (250g)',           kcal: 320, p: 26,   c: 12,   f: 18,   cat: 'prato' },
  { name: 'Moqueca capixaba (250g)',           kcal: 280, p: 26,   c: 10,   f: 15,   cat: 'prato' },
  { name: 'Vaca atolada (300g)',               kcal: 480, p: 35,   c: 22,   f: 28,   cat: 'prato' },
  { name: 'Rabada (300g)',                     kcal: 580, p: 38,   c: 12,   f: 42,   cat: 'prato' },
  { name: 'Picadinho de carne (200g)',         kcal: 320, p: 28,   c: 12,   f: 18,   cat: 'prato' },
  { name: 'Carne de panela (200g)',            kcal: 350, p: 30,   c: 10,   f: 22,   cat: 'prato' },
  { name: 'Pernil suíno assado (200g)',        kcal: 380, p: 35,   c: 0,    f: 24,   cat: 'proteina' },
  { name: 'Costelinha suína (200g)',           kcal: 480, p: 25,   c: 8,    f: 38,   cat: 'proteina' },

  // ===== Comidas regionais =====
  { name: 'Acarajé (1un)',                     kcal: 380, p: 12,   c: 28,   f: 24,   cat: 'erro' },
  { name: 'Vatapá (200g)',                     kcal: 320, p: 12,   c: 28,   f: 18,   cat: 'prato' },
  { name: 'Caruru (200g)',                     kcal: 280, p: 10,   c: 22,   f: 16,   cat: 'prato' },
  { name: 'Tapioca simples (1un)',             kcal: 150, p: 1,    c: 35,   f: 0.5,  cat: 'carb' },
  { name: 'Tapioca de queijo (1un)',           kcal: 280, p: 14,   c: 35,   f: 11,   cat: 'prato' },
  { name: 'Tapioca de frango (1un)',           kcal: 320, p: 22,   c: 36,   f: 12,   cat: 'prato' },
  { name: 'Tapioca de presunto e queijo (1un)', kcal: 310, p: 16,   c: 36,   f: 12,   cat: 'prato' },
  { name: 'Tapioca doce banana e canela (1un)', kcal: 230, p: 2,    c: 50,   f: 2,    cat: 'doce' },
  { name: 'Tapioca doce Nutella (1un)',        kcal: 380, p: 4,    c: 55,   f: 16,   cat: 'doce' },
  { name: 'Cuscuz paulista (200g)',            kcal: 320, p: 14,   c: 42,   f: 12,   cat: 'prato' },
  { name: 'Cuscuz nordestino com manteiga (200g)', kcal: 280, p: 6,    c: 50,   f: 7,    cat: 'prato' },
  { name: 'Cuscuz com leite (200g)',           kcal: 300, p: 10,   c: 45,   f: 9,    cat: 'prato' },
  { name: 'Pamonha salgada (1un)',             kcal: 280, p: 8,    c: 38,   f: 12,   cat: 'prato' },

  // ===== Pizzas extras =====
  { name: 'Pizza muçarela broto (4 fatias)',   kcal: 480, p: 22,   c: 60,   f: 16,   cat: 'erro' },
  { name: 'Pizza margherita (1 fatia)',        kcal: 250, p: 11,   c: 30,   f: 10,   cat: 'erro' },
  { name: 'Pizza pepperoni (1 fatia)',         kcal: 310, p: 13,   c: 32,   f: 14,   cat: 'erro' },
  { name: 'Pizza frango com catupiry (1 fatia)', kcal: 290, p: 14,   c: 30,   f: 12,   cat: 'erro' },
  { name: 'Pizza marguerita massa fina (1 fatia)', kcal: 200, p: 8,    c: 28,   f: 6,    cat: 'erro' },
  { name: 'Pizza brigadeiro doce (1 fatia)',   kcal: 320, p: 5,    c: 50,   f: 11,   cat: 'doce' },
  { name: 'Pizza chocolate com morango (1 fatia)', kcal: 340, p: 5,    c: 52,   f: 13,   cat: 'doce' },
  { name: 'Pizza Hut Personal Pepperoni',      kcal: 580, p: 24,   c: 65,   f: 23,   cat: 'erro' },

  // ===== Fast food =====
  { name: "McDonald's Quarteirão",             kcal: 540, p: 25,   c: 42,   f: 28,   cat: 'erro' },
  { name: "McDonald's McChicken",              kcal: 380, p: 16,   c: 38,   f: 18,   cat: 'erro' },
  { name: "McDonald's McFish",                 kcal: 380, p: 14,   c: 39,   f: 18,   cat: 'erro' },
  { name: 'Burger King X-Tudo',                kcal: 720, p: 32,   c: 50,   f: 42,   cat: 'erro' },
  { name: 'KFC balde (4 pedaços frango)',      kcal: 1120, p: 80,  c: 50,   f: 60,   cat: 'erro' },
  { name: "Bob's Big Bob",                     kcal: 540, p: 25,   c: 45,   f: 28,   cat: 'erro' },
  { name: "Habib's beirute carne (1un)",       kcal: 480, p: 22,   c: 45,   f: 22,   cat: 'erro' },
  { name: "Habib's esfiha de carne (3un)",     kcal: 510, p: 21,   c: 48,   f: 21,   cat: 'erro' },
  { name: 'Subway frango teriyaki 15cm',       kcal: 380, p: 25,   c: 50,   f: 9,    cat: 'prato' },
  { name: 'Subway atum 15cm',                  kcal: 480, p: 22,   c: 45,   f: 22,   cat: 'erro' },
  { name: 'Subway peru 15cm',                  kcal: 290, p: 18,   c: 47,   f: 4.5,  cat: 'prato' },
  { name: 'Subway frango c/ queijo 15cm',      kcal: 420, p: 26,   c: 50,   f: 12,   cat: 'prato' },

  // ===== Açaí =====
  { name: 'Açaí na tigela 300ml puro',         kcal: 240, p: 4,    c: 38,   f: 8,    cat: 'fruta' },
  { name: 'Açaí com granola e banana (300ml)', kcal: 380, p: 6,    c: 60,   f: 11,   cat: 'fruta' },
  { name: 'Açaí completo c/ leite condensado (400ml)', kcal: 580, p: 8,    c: 90,   f: 18,   cat: 'doce' },
  { name: 'Açaí com paçoca (300ml)',           kcal: 420, p: 8,    c: 60,   f: 14,   cat: 'doce' },
  { name: 'Açaí com Nutella (300ml)',          kcal: 480, p: 6,    c: 70,   f: 18,   cat: 'doce' },
  { name: 'Vitamina de açaí com banana (300ml)', kcal: 320, p: 5,    c: 55,   f: 8,    cat: 'fruta' },

  // ===== Vegetariano / vegano =====
  { name: 'Tofu grelhado (100g)',              kcal: 145, p: 17,   c: 4,    f: 8,    cat: 'proteina' },
  { name: 'Tofu salteado com legumes (150g)',  kcal: 220, p: 18,   c: 18,   f: 11,   cat: 'prato' },
  { name: 'Falafel (3 bolinhas)',              kcal: 280, p: 12,   c: 28,   f: 15,   cat: 'erro' },
  { name: 'Hambúrguer de grão de bico (1un)',  kcal: 220, p: 11,   c: 25,   f: 9,    cat: 'prato' },
  { name: 'Hambúrguer de feijão preto (1un)',  kcal: 200, p: 10,   c: 28,   f: 5,    cat: 'prato' },
  { name: 'Strogonoff de cogumelo (200g)',     kcal: 240, p: 8,    c: 18,   f: 16,   cat: 'prato' },
  { name: 'Risotto de cogumelos (250g)',       kcal: 380, p: 9,    c: 55,   f: 13,   cat: 'prato' },
  { name: 'Curry vegetariano com grão de bico (250g)', kcal: 320, p: 12,   c: 42,   f: 11,   cat: 'prato' },
  { name: 'Wrap de homus e vegetais (1un)',    kcal: 380, p: 13,   c: 50,   f: 13,   cat: 'prato' },
  { name: 'Salada de quinoa com legumes (250g)', kcal: 320, p: 12,   c: 45,   f: 10,   cat: 'prato' },
  { name: 'Buddha bowl vegano (300g)',         kcal: 480, p: 16,   c: 60,   f: 17,   cat: 'prato' },
  { name: 'Lentilha refogada (200g)',          kcal: 220, p: 16,   c: 32,   f: 2,    cat: 'prato' },
  { name: 'Grão de bico cozido (100g)',        kcal: 165, p: 9,    c: 28,   f: 3,    cat: 'carb' },
  { name: 'Feijão branco refogado (200g)',     kcal: 240, p: 14,   c: 38,   f: 3,    cat: 'prato' },
  { name: 'Soja texturizada cozida (100g)',    kcal: 95,  p: 14,   c: 7,    f: 0.5,  cat: 'proteina' },
  { name: 'Hummus (3col sopa)',                kcal: 130, p: 4,    c: 12,   f: 7,    cat: 'gordura' },

  // ===== Sopas =====
  { name: 'Sopa de legumes (300ml)',           kcal: 150, p: 8,    c: 22,   f: 4,    cat: 'prato' },
  { name: 'Sopa creme de abóbora (300ml)',     kcal: 180, p: 5,    c: 25,   f: 7,    cat: 'prato' },
  { name: 'Sopa creme de mandioquinha (300ml)', kcal: 220, p: 5,    c: 32,   f: 8,    cat: 'prato' },
  { name: 'Sopa caldo verde (300ml)',          kcal: 280, p: 12,   c: 26,   f: 14,   cat: 'prato' },
  { name: 'Canja de galinha (300ml)',          kcal: 220, p: 18,   c: 22,   f: 6,    cat: 'prato' },
  { name: 'Sopa minestrone (300ml)',           kcal: 200, p: 9,    c: 28,   f: 6,    cat: 'prato' },
  { name: 'Caldo de mandioca (300ml)',         kcal: 180, p: 8,    c: 28,   f: 4,    cat: 'prato' },
  { name: 'Caldo de feijão (300ml)',           kcal: 240, p: 14,   c: 32,   f: 5,    cat: 'prato' },
  { name: 'Sopa de capeletti (300ml)',         kcal: 320, p: 12,   c: 42,   f: 10,   cat: 'prato' },

  // ===== Suplementos / fitness =====
  { name: 'Whey isolado (1 scoop 30g)',        kcal: 110, p: 25,   c: 2,    f: 0.5,  cat: 'supl' },
  { name: 'Whey concentrado (1 scoop 30g)',    kcal: 130, p: 22,   c: 4,    f: 2,    cat: 'supl' },
  { name: 'Caseína (1 scoop 30g)',             kcal: 120, p: 24,   c: 3,    f: 1.5,  cat: 'supl' },
  { name: 'Albumina (10g)',                    kcal: 38,  p: 8,    c: 1,    f: 0.2,  cat: 'supl' },
  { name: 'Creatina monohidratada (5g)',       kcal: 0,   p: 0,    c: 0,    f: 0,    cat: 'supl' },
  { name: 'BCAA (5g)',                         kcal: 18,  p: 4.5,  c: 0,    f: 0,    cat: 'supl' },
  { name: 'Glutamina (5g)',                    kcal: 20,  p: 5,    c: 0,    f: 0,    cat: 'supl' },
  { name: 'Hipercalórico massa (1 scoop 50g)', kcal: 200, p: 12,   c: 32,   f: 2,    cat: 'supl' },
  { name: 'Shake proteico caseiro (banana+whey+leite)', kcal: 380, p: 35,   c: 38,   f: 8,    cat: 'supl' },
  { name: 'Iso whey c/ água (300ml)',          kcal: 130, p: 27,   c: 3,    f: 1,    cat: 'supl' },

  // ===== Bebidas funcionais =====
  { name: 'Kombucha sabor original (200ml)',   kcal: 30,  p: 0,    c: 7,    f: 0,    cat: 'bebida' },
  { name: 'Pré-treino bebida (200ml)',         kcal: 15,  p: 0,    c: 4,    f: 0,    cat: 'bebida' },
  { name: 'Gatorade (500ml)',                  kcal: 130, p: 0,    c: 32,   f: 0,    cat: 'bebida' },
  { name: 'Powerade (500ml)',                  kcal: 110, p: 0,    c: 28,   f: 0,    cat: 'bebida' },
  { name: 'Red Bull (250ml)',                  kcal: 110, p: 1,    c: 28,   f: 0,    cat: 'bebida' },
  { name: 'Monster Energy (500ml)',            kcal: 230, p: 0,    c: 55,   f: 0,    cat: 'bebida' },
  { name: 'Água de coco (200ml)',              kcal: 40,  p: 0.5,  c: 9,    f: 0.2,  cat: 'bebida' },
  { name: 'Suco verde detox (300ml)',          kcal: 90,  p: 3,    c: 18,   f: 0.5,  cat: 'bebida' },

  // ===== Massas e risotos extras =====
  { name: 'Espaguete ao alho e óleo (200g)',   kcal: 320, p: 9,    c: 50,   f: 9,    cat: 'prato' },
  { name: 'Penne ao molho rosé (200g)',        kcal: 380, p: 12,   c: 50,   f: 14,   cat: 'prato' },
  { name: 'Talharim ao funghi (200g)',         kcal: 380, p: 11,   c: 52,   f: 13,   cat: 'prato' },
  { name: 'Nhoque de batata ao sugo (200g)',   kcal: 320, p: 9,    c: 55,   f: 7,    cat: 'prato' },
  { name: 'Nhoque ao molho branco (200g)',     kcal: 380, p: 11,   c: 50,   f: 14,   cat: 'prato' },
  { name: 'Ravioli de ricota (200g)',          kcal: 350, p: 14,   c: 45,   f: 12,   cat: 'prato' },
  { name: 'Tortelloni à carbonara (200g)',     kcal: 420, p: 16,   c: 48,   f: 16,   cat: 'prato' },
  { name: 'Risoto à milanesa (200g)',          kcal: 320, p: 8,    c: 48,   f: 10,   cat: 'prato' },
  { name: 'Risoto de camarão (200g)',          kcal: 380, p: 22,   c: 38,   f: 13,   cat: 'prato' },
  { name: 'Risoto de aspargos (200g)',         kcal: 320, p: 8,    c: 50,   f: 9,    cat: 'prato' },

  // ===== Snacks salgados (marcas) =====
  { name: 'Doritos sweet chili (50g)',         kcal: 250, p: 3,    c: 32,   f: 12,   cat: 'snack' },
  { name: 'Doritos queijo nacho (50g)',        kcal: 260, p: 3,    c: 32,   f: 13,   cat: 'snack' },
  { name: 'Cheetos requeijão (50g)',           kcal: 260, p: 3,    c: 30,   f: 14,   cat: 'snack' },
  { name: 'Ruffles original (50g)',            kcal: 270, p: 3,    c: 32,   f: 14,   cat: 'snack' },
  { name: 'Lays ondulada (50g)',               kcal: 270, p: 3,    c: 32,   f: 14,   cat: 'snack' },
  { name: 'Torcida presunto (50g)',            kcal: 260, p: 3,    c: 35,   f: 12,   cat: 'snack' },
  { name: 'Fandangos churrasco (50g)',         kcal: 250, p: 4,    c: 32,   f: 12,   cat: 'snack' },
  { name: 'Baconzitos (50g)',                  kcal: 270, p: 3,    c: 32,   f: 14,   cat: 'snack' },
  { name: 'Skin chips (50g)',                  kcal: 270, p: 4,    c: 30,   f: 14,   cat: 'snack' },
  { name: 'Pipoca de microondas amanteigada (50g)', kcal: 240, p: 4,    c: 28,   f: 12,   cat: 'snack' },
  { name: 'Pipoca doce caramelizada (50g)',    kcal: 220, p: 2,    c: 38,   f: 7,    cat: 'snack' },
  { name: 'Castanha de caju torrada (30g)',    kcal: 175, p: 5,    c: 9,    f: 14,   cat: 'gordura' },
  { name: 'Pistache torrado (30g)',            kcal: 170, p: 6,    c: 8,    f: 14,   cat: 'gordura' },
  { name: 'Nozes (30g)',                       kcal: 195, p: 5,    c: 4,    f: 19,   cat: 'gordura' },
  { name: 'Castanha do Pará (3un)',            kcal: 100, p: 2,    c: 1,    f: 10,   cat: 'gordura' },
  { name: 'Mix de castanhas (30g)',            kcal: 180, p: 5,    c: 6,    f: 16,   cat: 'gordura' },
  { name: 'Tâmaras (3un)',                     kcal: 90,  p: 1,    c: 22,   f: 0.1,  cat: 'fruta' },
  { name: 'Damasco seco (5un)',                kcal: 85,  p: 1,    c: 22,   f: 0.2,  cat: 'fruta' },

  // ===== Sobremesas geladas =====
  { name: 'Sorvete creme (100g)',              kcal: 220, p: 4,    c: 26,   f: 11,   cat: 'doce' },
  { name: 'Sorvete chocolate (100g)',          kcal: 240, p: 4,    c: 28,   f: 12,   cat: 'doce' },
  { name: 'Sorvete morango (100g)',            kcal: 200, p: 3,    c: 28,   f: 9,    cat: 'doce' },
  { name: "Sorvete Ben & Jerry's chocolate (100g)", kcal: 320, p: 5,    c: 30,   f: 18,   cat: 'doce' },
  { name: 'Sorvete Häagen-Dazs (100g)',        kcal: 280, p: 5,    c: 24,   f: 18,   cat: 'doce' },
  { name: 'Picolé de fruta (1un)',             kcal: 70,  p: 0,    c: 17,   f: 0,    cat: 'doce' },
  { name: 'Picolé chocolate (1un)',            kcal: 130, p: 2,    c: 18,   f: 6,    cat: 'doce' },
  { name: 'Magnum amêndoas (1un)',             kcal: 240, p: 3,    c: 23,   f: 16,   cat: 'doce' },
  { name: 'Casquinha de sorvete (1un)',        kcal: 280, p: 5,    c: 35,   f: 14,   cat: 'doce' },
  { name: 'Banana split (1un)',                kcal: 480, p: 8,    c: 80,   f: 16,   cat: 'doce' },
  { name: 'Frozen yogurt (1 porção 200g)',     kcal: 220, p: 8,    c: 38,   f: 4,    cat: 'doce' },

  // ===== Ovos preparados =====
  { name: 'Omelete simples (2 ovos)',          kcal: 180, p: 14,   c: 1,    f: 13,   cat: 'proteina' },
  { name: 'Omelete c/ queijo (2 ovos)',        kcal: 280, p: 20,   c: 1,    f: 22,   cat: 'proteina' },
  { name: 'Omelete c/ frango (200g)',          kcal: 320, p: 32,   c: 1,    f: 20,   cat: 'proteina' },
  { name: 'Ovo poché (1un)',                   kcal: 70,  p: 6,    c: 0,    f: 5,    cat: 'proteina' },
  { name: 'Ovo cozido (1un)',                  kcal: 70,  p: 6,    c: 0,    f: 5,    cat: 'proteina' },
  { name: 'Ovo mexido c/ manteiga (2 ovos)',   kcal: 220, p: 13,   c: 1,    f: 18,   cat: 'proteina' },
  { name: 'Ovo Benedict (1un)',                kcal: 350, p: 18,   c: 22,   f: 22,   cat: 'prato' },

  // ===== Carnes adicionais =====
  { name: 'Carré de cordeiro (200g)',          kcal: 480, p: 35,   c: 0,    f: 36,   cat: 'proteina' },
  { name: 'Pato assado (200g)',                kcal: 480, p: 28,   c: 0,    f: 38,   cat: 'proteina' },
  { name: 'Codorna assada (1un 150g)',         kcal: 280, p: 28,   c: 0,    f: 18,   cat: 'proteina' },
  { name: 'Coelho ensopado (200g)',            kcal: 300, p: 35,   c: 5,    f: 14,   cat: 'proteina' },
  { name: 'Tender natalino (200g)',            kcal: 380, p: 28,   c: 14,   f: 22,   cat: 'proteina' },
  { name: 'Peru de Natal (200g)',              kcal: 320, p: 38,   c: 0,    f: 18,   cat: 'proteina' },
  { name: 'Bacalhau ao forno (250g)',          kcal: 380, p: 38,   c: 20,   f: 16,   cat: 'prato' },

  // ===== Salgados finger food / gourmet =====
  { name: 'Bruschetta tomate e manjericão (1un)', kcal: 130, p: 4,    c: 18,   f: 5,    cat: 'prato' },
  { name: 'Carpaccio (100g)',                  kcal: 220, p: 22,   c: 4,    f: 14,   cat: 'proteina' },
  { name: 'Tartar de salmão (100g)',           kcal: 220, p: 20,   c: 2,    f: 14,   cat: 'proteina' },
  { name: 'Croquete de bacalhau (1un)',        kcal: 120, p: 6,    c: 10,   f: 6,    cat: 'erro' },
  { name: 'Bolinho de bacalhau (1un grande)',  kcal: 180, p: 9,    c: 14,   f: 9,    cat: 'erro' },
  { name: 'Bolinho de carne (1un)',            kcal: 150, p: 8,    c: 12,   f: 7,    cat: 'erro' },
  { name: 'Mini quiche (1un)',                 kcal: 130, p: 4,    c: 9,    f: 9,    cat: 'erro' },

  // ===== Pães especiais =====
  { name: 'Pão de batata recheado (1un)',      kcal: 240, p: 7,    c: 30,   f: 9,    cat: 'erro' },
  { name: 'Pão sírio (1un médio)',             kcal: 180, p: 6,    c: 32,   f: 1.5,  cat: 'carb' },
  { name: 'Pão árabe (1un)',                   kcal: 220, p: 8,    c: 40,   f: 2,    cat: 'carb' },
  { name: 'Pão preto integral fatia (1un)',    kcal: 90,  p: 4,    c: 17,   f: 1,    cat: 'carb' },
  { name: 'Brioche (1un)',                     kcal: 280, p: 7,    c: 38,   f: 11,   cat: 'erro' },
  { name: 'Bagel (1un)',                       kcal: 280, p: 11,   c: 56,   f: 1.5,  cat: 'carb' },
  { name: 'Ciabatta (1un)',                    kcal: 230, p: 8,    c: 45,   f: 1.5,  cat: 'carb' },
  { name: 'Pão sourdough (1 fatia)',           kcal: 130, p: 5,    c: 26,   f: 1,    cat: 'carb' },
  { name: 'Focaccia (100g)',                   kcal: 320, p: 8,    c: 42,   f: 14,   cat: 'erro' },

  // ===== Granolas e cereais =====
  { name: 'Granola caseira (50g)',             kcal: 220, p: 6,    c: 30,   f: 9,    cat: 'carb' },
  { name: 'Granola Nestlé (50g)',              kcal: 230, p: 5,    c: 35,   f: 8,    cat: 'carb' },
  { name: 'Granola low carb (40g)',            kcal: 180, p: 9,    c: 12,   f: 11,   cat: 'gordura' },
  { name: 'Aveia em flocos (30g)',             kcal: 110, p: 5,    c: 18,   f: 2,    cat: 'carb' },
  { name: 'Sucrilhos com leite (1 tigela)',    kcal: 250, p: 8,    c: 45,   f: 4,    cat: 'erro' },
  { name: 'Nesfit (1 tigela)',                 kcal: 220, p: 8,    c: 45,   f: 3,    cat: 'carb' },
  { name: 'All Bran (40g)',                    kcal: 130, p: 4,    c: 30,   f: 1.5,  cat: 'carb' },
  { name: 'Mingau de aveia simples (250g)',    kcal: 220, p: 9,    c: 32,   f: 6,    cat: 'carb' },
  { name: 'Mingau de aveia com banana (300g)', kcal: 320, p: 11,   c: 50,   f: 7,    cat: 'carb' },
  { name: 'Mingau de fubá com leite (300g)',   kcal: 380, p: 11,   c: 55,   f: 11,   cat: 'carb' },

  // ===== Yogurts e laticínios =====
  { name: 'Iogurte grego natural (130g)',      kcal: 130, p: 10,   c: 6,    f: 6,    cat: 'proteina' },
  { name: 'Iogurte grego sabor mel (130g)',    kcal: 160, p: 9,    c: 16,   f: 6,    cat: 'doce' },
  { name: 'Iogurte natural integral (170g)',   kcal: 110, p: 6,    c: 9,    f: 5,    cat: 'proteina' },
  { name: 'Iogurte natural desnatado (170g)',  kcal: 65,  p: 7,    c: 9,    f: 0.3,  cat: 'proteina' },
  { name: 'Iogurte zero açúcar (170g)',        kcal: 60,  p: 6,    c: 8,    f: 0.5,  cat: 'proteina' },
  { name: 'Iogurte com aveia (170g)',          kcal: 145, p: 7,    c: 22,   f: 3,    cat: 'carb' },
  { name: 'Iogurte proteico (250g)',           kcal: 180, p: 22,   c: 12,   f: 5,    cat: 'proteina' },
  { name: 'Coalhada seca caseira (100g)',      kcal: 90,  p: 9,    c: 4,    f: 4,    cat: 'proteina' },
  { name: 'Leite condensado (1col sopa)',      kcal: 90,  p: 2,    c: 16,   f: 2.5,  cat: 'doce' },
  { name: 'Creme de leite (1col sopa)',        kcal: 30,  p: 0.5,  c: 0.7,  f: 3,    cat: 'gordura' },
  { name: 'Requeijão cremoso (1col sopa)',     kcal: 50,  p: 1.5,  c: 1,    f: 5,    cat: 'gordura' },
  { name: 'Cream cheese (1col sopa)',          kcal: 50,  p: 1,    c: 1,    f: 5,    cat: 'gordura' },
  { name: 'Queijo cottage (3col sopa)',        kcal: 95,  p: 13,   c: 3,    f: 4,    cat: 'proteina' },
  { name: 'Queijo brie (30g)',                 kcal: 100, p: 6,    c: 0,    f: 8,    cat: 'gordura' },
  { name: 'Queijo coalho (50g)',               kcal: 175, p: 12,   c: 1,    f: 14,   cat: 'gordura' },
  { name: 'Queijo gorgonzola (30g)',           kcal: 105, p: 6,    c: 0.5,  f: 9,    cat: 'gordura' },
  { name: 'Mussarela de búfala (50g)',         kcal: 135, p: 9,    c: 1,    f: 11,   cat: 'gordura' },

  // ===== Vegetais preparados =====
  { name: 'Brócolis no vapor (100g)',          kcal: 35,  p: 3,    c: 7,    f: 0.4,  cat: 'veg' },
  { name: 'Brócolis refogado no alho (100g)',  kcal: 80,  p: 3,    c: 7,    f: 5,    cat: 'veg' },
  { name: 'Couve refogada (100g)',             kcal: 75,  p: 4,    c: 7,    f: 4,    cat: 'veg' },
  { name: 'Espinafre refogado (100g)',         kcal: 60,  p: 4,    c: 5,    f: 4,    cat: 'veg' },
  { name: 'Berinjela à parmegiana (200g)',     kcal: 320, p: 14,   c: 22,   f: 18,   cat: 'prato' },
  { name: 'Abobrinha refogada (100g)',         kcal: 45,  p: 1.5,  c: 5,    f: 2.5,  cat: 'veg' },
  { name: 'Quiabo refogado (100g)',            kcal: 55,  p: 2,    c: 7,    f: 2.5,  cat: 'veg' },
  { name: 'Couve-flor gratinada (200g)',       kcal: 220, p: 9,    c: 12,   f: 14,   cat: 'prato' },
  { name: 'Aspargos grelhados (100g)',         kcal: 30,  p: 3,    c: 5,    f: 0.5,  cat: 'veg' },
  { name: 'Cogumelos shimeji refogados (100g)', kcal: 70,  p: 3,    c: 5,    f: 4,    cat: 'veg' },
  { name: 'Salada caesar c/ frango (250g)',    kcal: 380, p: 28,   c: 15,   f: 22,   cat: 'prato' },
  { name: 'Salada Cobb (300g)',                kcal: 480, p: 26,   c: 12,   f: 36,   cat: 'prato' },

  // ===== Comfort food americano =====
  { name: 'Mac & cheese (200g)',               kcal: 380, p: 14,   c: 38,   f: 18,   cat: 'erro' },
  { name: 'Chili con carne (250g)',            kcal: 380, p: 28,   c: 28,   f: 16,   cat: 'prato' },
  { name: 'Buffalo wings (5un)',               kcal: 480, p: 32,   c: 4,    f: 36,   cat: 'erro' },
  { name: 'Onion rings (8un)',                 kcal: 380, p: 5,    c: 38,   f: 22,   cat: 'erro' },
  { name: 'Mozzarella sticks (5un)',           kcal: 380, p: 18,   c: 26,   f: 22,   cat: 'erro' },
  { name: 'Nachos com queijo (300g)',          kcal: 580, p: 14,   c: 60,   f: 30,   cat: 'erro' },
  { name: 'Quesadilla de queijo (1un)',        kcal: 380, p: 16,   c: 35,   f: 18,   cat: 'prato' },
  { name: 'Burrito de frango (1un grande)',    kcal: 580, p: 28,   c: 60,   f: 22,   cat: 'prato' },
  { name: 'Taco crocante de carne (1un)',      kcal: 220, p: 9,    c: 16,   f: 12,   cat: 'erro' },
  { name: 'Pancake americana (3un)',           kcal: 380, p: 11,   c: 50,   f: 14,   cat: 'doce' },
  { name: 'Waffle com xarope (1un)',           kcal: 380, p: 8,    c: 55,   f: 14,   cat: 'doce' },
  { name: 'Coxinha de Asa (kebab 200g)',       kcal: 380, p: 28,   c: 5,    f: 28,   cat: 'erro' },

  // ===== Frutas extras =====
  { name: 'Pitaya (100g)',                     kcal: 60,  p: 1,    c: 13,   f: 0.4,  cat: 'fruta' },
  { name: 'Pitaya bowl c/ granola e mel (200g)', kcal: 280, p: 7,    c: 50,   f: 6,    cat: 'fruta' },
  { name: 'Caqui (1un)',                       kcal: 90,  p: 1,    c: 24,   f: 0.2,  cat: 'fruta' },
  { name: 'Romã (1un)',                        kcal: 105, p: 2,    c: 26,   f: 0.7,  cat: 'fruta' },
  { name: 'Manga rosa (1un)',                  kcal: 140, p: 1,    c: 35,   f: 0.6,  cat: 'fruta' },
  { name: 'Manga palmer (1un)',                kcal: 130, p: 1,    c: 32,   f: 0.6,  cat: 'fruta' },
  { name: 'Maracujá (1un)',                    kcal: 30,  p: 1,    c: 8,    f: 0.2,  cat: 'fruta' },
  { name: 'Carambola (1un)',                   kcal: 30,  p: 0.5,  c: 8,    f: 0.3,  cat: 'fruta' },
  { name: 'Cupuaçu (100g)',                    kcal: 70,  p: 1.5,  c: 16,   f: 0.5,  cat: 'fruta' },
  { name: 'Cajá (100g)',                       kcal: 45,  p: 0.8,  c: 11,   f: 0.2,  cat: 'fruta' },
  { name: 'Sapoti (1un)',                      kcal: 95,  p: 1,    c: 24,   f: 0.3,  cat: 'fruta' },
  { name: 'Jenipapo (100g)',                   kcal: 105, p: 1,    c: 25,   f: 0.5,  cat: 'fruta' },

  // ===== Especiais (asiáticos extras + comfort gourmet) =====
  { name: 'Pad thai (300g)',                   kcal: 480, p: 18,   c: 60,   f: 16,   cat: 'prato' },
  { name: 'Curry tailandês (250g)',            kcal: 380, p: 22,   c: 32,   f: 18,   cat: 'prato' },
  { name: 'Bento box (1 box completa)',        kcal: 580, p: 28,   c: 70,   f: 18,   cat: 'prato' },
  { name: 'Dim sum variados (5un)',            kcal: 280, p: 10,   c: 30,   f: 12,   cat: 'prato' },
  { name: 'Spring roll fresco (2un)',          kcal: 130, p: 5,    c: 22,   f: 2.5,  cat: 'prato' },
  { name: 'Spring roll frito (2un)',           kcal: 220, p: 5,    c: 24,   f: 11,   cat: 'erro' },
  { name: 'Frango xadrez chinês (200g)',       kcal: 320, p: 24,   c: 22,   f: 14,   cat: 'prato' },
  { name: 'Frango oriental agridoce (200g)',   kcal: 380, p: 22,   c: 35,   f: 14,   cat: 'prato' },

  // ===== Bolos =====
  { name: 'Bolo de cenoura com cobertura (fatia 100g)', kcal: 380, p: 5,    c: 50,   f: 17,   cat: 'doce' },
  { name: 'Bolo formigueiro (fatia 100g)',     kcal: 320, p: 5,    c: 48,   f: 12,   cat: 'doce' },
  { name: 'Bolo de fubá (fatia 100g)',         kcal: 280, p: 5,    c: 42,   f: 9,    cat: 'doce' },
  { name: 'Bolo de banana (fatia 100g)',       kcal: 250, p: 4,    c: 38,   f: 9,    cat: 'doce' },
  { name: 'Bolo red velvet (fatia 100g)',      kcal: 380, p: 5,    c: 48,   f: 18,   cat: 'doce' },
  { name: 'Bolo Naked (fatia 150g)',           kcal: 480, p: 7,    c: 60,   f: 22,   cat: 'doce' },
  { name: 'Cupcake chocolate (1un)',           kcal: 280, p: 4,    c: 36,   f: 14,   cat: 'doce' },
  { name: 'Cupcake red velvet (1un)',          kcal: 320, p: 4,    c: 38,   f: 17,   cat: 'doce' },
  { name: 'Bolo de chocolate caseiro (fatia 100g)', kcal: 350, p: 5,    c: 48,   f: 15,   cat: 'doce' },
  { name: 'Bolo de milho cremoso (fatia 100g)', kcal: 290, p: 5,    c: 45,   f: 10,   cat: 'doce' },
];
...
const CHARACTERS = [
  { id: 'yeonjun', slot: '1P', name: 'YEONJUN', title: 'THE BLUE HOUR',
    ...
    workouts: {
      ...
      'icons/workouts/abs.webp':        'icons/characters/yeonjun/abs.webp',
      'icons/workouts/pernas.webp':     'icons/characters/yeonjun/pernas.webp',
      'icons/workouts/caminhada.webp':  'icons/characters/yeonjun/caminhada.webp',
      'icons/workouts/calistenia.webp': 'icons/characters/yeonjun/calistenia.webp',
      'icons/workouts/bracos.webp':     'icons/characters/yeonjun/costas.webp',
      'icons/workouts/core.webp':       'icons/characters/yeonjun/abs.webp',
      'icons/workouts/ombros.webp':     'icons/characters/yeonjun/costas.webp',
      'icons/workouts/ombros2.webp':    'icons/characters/yeonjun/peito.webp',
    },
    workoutPositions: {
      'icons/characters/yeonjun/peito.webp':      'center 30%',
      'icons/characters/yeonjun/costas.webp':     'center 35%',
      'icons/characters/yeonjun/abs.webp':        'center 40%',
      'icons/characters/yeonjun/pernas.webp':     'center 50%',
      'icons/characters/yeonjun/caminhada.webp':  'center 30%',
      'icons/characters/yeonjun/calistenia.webp': 'center 50%',
    },
    bodyStates: {
      magrelo:  'icons/characters/yeonjun/bodies/magrelo.webp',
      lean:     'icons/characters/yeonjun/bodies/lean.webp',
      athletic: 'icons/characters/yeonjun/bodies/athletic.webp',
      bulked:   'icons/characters/yeonjun/bodies/bulked.webp',
      fat:      'icons/characters/yeonjun/bodies/fat.webp',
    },
  },
  { id: 'cagemorgan', slot: '2P', name: 'CAGE MORGAN', title: 'THE LAST TAKE',
    ...
    workouts: {
      ...
      'icons/workouts/abs.webp':        'icons/characters/cagemorgan/abs.webp',
      'icons/workouts/pernas.webp':     'icons/characters/cagemorgan/pernas.webp',
      'icons/workouts/caminhada.webp':  'icons/characters/cagemorgan/caminhada.webp',
      'icons/workouts/calistenia.webp': 'icons/characters/cagemorgan/calistenia.webp',
      'icons/workouts/bracos.webp':     'icons/characters/cagemorgan/costas.webp',
      'icons/workouts/core.webp':       'icons/characters/cagemorgan/abs.webp',
      'icons/workouts/ombros.webp':     'icons/characters/cagemorgan/costas.webp',
      'icons/workouts/ombros2.webp':    'icons/characters/cagemorgan/peito.webp',
    },
    workoutPositions: {
      'icons/characters/cagemorgan/peito.webp':      'center 30%',
      'icons/characters/cagemorgan/costas.webp':     'center 35%',
      'icons/characters/cagemorgan/abs.webp':        'center 40%',
      'icons/characters/cagemorgan/pernas.webp':     'center 50%',
  ...
  { id: 'sanji', slot: '3P', name: 'SANJI', title: 'THE BLACK LEG',
    ...
    workouts: {
      ...
      'icons/workouts/abs.webp':        'icons/characters/sanji/abs.webp',
      'icons/workouts/pernas.webp':     'icons/characters/sanji/pernas.webp',
      'icons/workouts/caminhada.webp':  'icons/characters/sanji/caminhada.webp',
      'icons/workouts/calistenia.webp': 'icons/characters/sanji/calistenia.webp',
      'icons/workouts/bracos.webp':     'icons/characters/sanji/costas.webp',
      'icons/workouts/core.webp':       'icons/characters/sanji/abs.webp',
      'icons/workouts/ombros.webp':     'icons/characters/sanji/costas.webp',
      'icons/workouts/ombros2.webp':    'icons/characters/sanji/peito.webp',
    },
    workoutPositions: {
      'icons/characters/sanji/peito.webp':      'center 30%',
      'icons/characters/sanji/costas.webp':     'center 35%',
      'icons/characters/sanji/abs.webp':        'center 40%',
      'icons/characters/sanji/pernas.webp':     'center 50%',
      'icons/characters/sanji/caminhada.webp':  'center 30%',
      'icons/characters/sanji/calistenia.webp': 'center 50%',
    },
    bodyStates: {
      magrelo:  'icons/characters/sanji/bodies/magrelo.webp',
      lean:     'icons/characters/sanji/bodies/lean.webp',
      athletic: 'icons/characters/sanji/bodies/athletic.webp',
      bulked:   'icons/characters/sanji/bodies/bulked.webp',
      fat:      'icons/characters/sanji/bodies/fat.webp',
    },
  },
  { id: 'joehigashi', slot: '4P', name: 'JOE HIGASHI', title: 'THE HURRICANE',
    ...
    workouts: {
      ...
      'icons/workouts/abs.webp':        'icons/characters/joehigashi/abs.webp',
      'icons/workouts/pernas.webp':     'icons/characters/joehigashi/pernas.webp',
      'icons/workouts/caminhada.webp':  'icons/characters/joehigashi/caminhada.webp',
      'icons/workouts/calistenia.webp': 'icons/characters/joehigashi/calistenia.webp',
      'icons/workouts/bracos.webp':     'icons/characters/joehigashi/costas.webp',
      'icons/workouts/core.webp':       'icons/characters/joehigashi/abs.webp',
      'icons/workouts/ombros.webp':     'icons/characters/joehigashi/costas.webp',
      'icons/workouts/ombros2.webp':    'icons/characters/joehigashi/peito.webp',
    },
    workoutPositions: {
      'icons/characters/joehigashi/peito.webp':      'center 35%',
      'icons/characters/joehigashi/costas.webp':     'center 35%',
      'icons/characters/joehigashi/abs.webp':        'center 40%',
      'icons/characters/joehigashi/pernas.webp':     'center 50%',
      'icons/characters/joehigashi/caminhada.webp':  'center 30%',
      'icons/characters/joehigashi/calistenia.webp': 'center 50%',
    },
    bodyStates: {
      magrelo:  'icons/characters/joehigashi/bodies/magrelo.webp',
      lean:     'icons/characters/joehigashi/bodies/lean.webp',
      athletic: 'icons/characters/joehigashi/bodies/athletic.webp',
      bulked:   'icons/characters/joehigashi/bodies/bulked.webp',
      fat:      'icons/characters/joehigashi/bodies/fat.webp',
    },
  },
  ...
  { id: 'jeno', slot: '6P', name: 'LEE JENO', title: 'THE MOON DRIVE',
    ...
    stats: { ATAQUE: 78, VELOCIDADE: 82, DEFESA: 60, TÉCNICA: 80, CARISMA: 96 },
    desc: 'Idol-atleta da NCT. Foco silencioso e físico cinzelado.',
    buff: 'forca',
    accent: '#B7B5FF', accentDeep: '#5852CC', accentGlow: '#D8D6FF',
    lore: 'Membro de NCT 127 / NCT Dream, apelidado "Nono" pelos fãs. Conhecido na indústria como o 헬창 (gym king) — corpo cinzelado, foco silencioso, sorriso de meia-lua que vira lâmina no palco.',
    age: 25, origin: 'Incheon, Coreia do Sul', style: 'Idol · Heavy Lifter',
    passives: [
      { icon: '💪', text: '+10% XP em treinos de hipertrofia' },
      { icon: '🌙', text: '+5% XP em sono bem registrado' },
    ],
    signature: { name: 'Moon Drive · 달의 드라이브', icon: '🌙',
      desc: 'Treinos noturnos (após 20h) rendem +25% XP. A lua acorda quando os outros dormem.' },
    workouts: {
      'icons/workouts/peito.webp':      'icons/characters/jeno/peito.webp',
      'icons/workouts/dorsal.webp':     'icons/characters/jeno/costas.webp',
      'icons/workouts/abs.webp':        'icons/characters/jeno/abs.webp',
      'icons/workouts/pernas.webp':     'icons/characters/jeno/pernas.webp',
      'icons/workouts/caminhada.webp':  'icons/characters/jeno/caminhada.webp',
      'icons/workouts/calistenia.webp': 'icons/characters/jeno/calistenia.webp',
      'icons/workouts/bracos.webp':     'icons/characters/jeno/costas.webp',
      'icons/workouts/core.webp':       'icons/characters/jeno/abs.webp',
      'icons/workouts/ombros.webp':     'icons/characters/jeno/costas.webp',
      'icons/workouts/ombros2.webp':    'icons/characters/jeno/peito.webp',
    },
    workoutPositions: {
      'icons/characters/jeno/peito.webp':      'center 30%',
      'icons/characters/jeno/costas.webp':     'center 35%',
      'icons/characters/jeno/abs.webp':        'center 40%',
  ...
  { id: 'dhano', slot: '7P', name: 'DHANO', title: 'THE RUTHLESS EYE',
    img: 'icons/characters/dhano.webp', unlocked: true,
    stats: { ATAQUE: 95, VELOCIDADE: 70, DEFESA: 85, TÉCNICA: 70, CARISMA: 80 },
    desc: 'Brutalista de aço. Não pisca, não dá trégua. Treina pra cravar.',
    buff: 'forca',
    accent: '#FF3D5E', accentDeep: '#7A0D1F', accentGlow: '#FF6B85',
    lore: 'Cibernético de gênese desconhecida. O olho que substituiu o original lê micro-movimentos e calcula a próxima rachadura na guarda do oponente. Voltou pra ringue depois de "morrer" três vezes na sombra.',
    age: 29, origin: 'Distrito Subterrâneo · Neo-Hollywood', style: 'Brawler · Apex Predator',
    passives: [
      { icon: '💢', text: '+15% XP em treinos pesados (séries com peso máximo)' },
      { icon: '🎯', text: '+10% XP quando bate PR (personal record)' },
    ],
    signature: { name: 'Ruthless Eye · 무자비한 눈', icon: '👁️',
      desc: 'A primeira série de qualquer treino rende +30% XP. Estabelece o tom — o olho não pisca antes do segundo set.' },
    workouts: {
      'icons/workouts/peito.webp':      'icons/characters/dhano/peito.webp',
      'icons/workouts/dorsal.webp':     'icons/characters/dhano/costas.webp',
      'icons/workouts/abs.webp':        'icons/characters/dhano/abs.webp',
      'icons/workouts/pernas.webp':     'icons/characters/dhano/pernas.webp',
      'icons/workouts/caminhada.webp':  'icons/characters/dhano/caminhada.webp',
      'icons/workouts/calistenia.webp': 'icons/characters/dhano/calistenia.webp',
      'icons/workouts/bracos.webp':     'icons/characters/dhano/costas.webp',
      'icons/workouts/core.webp':       'icons/characters/dhano/abs.webp',
      'icons/workouts/ombros.webp':     'icons/characters/dhano/costas.webp',
      'icons/workouts/ombros2.webp':    'icons/characters/dhano/peito.webp',
    },
    workoutPositions: {
      'icons/characters/dhano/peito.webp':      'center 35%',
      'icons/characters/dhano/costas.webp':     'center 35%',
      'icons/characters/dhano/abs.webp':        'center 40%',
      'icons/characters/dhano/pernas.webp':     'center 50%',
  ...
  { id: 'joonki', slot: '9P', name: 'JOONKI', title: 'THE MIRROR ACE',
    img: 'icons/characters/joonki.webp', unlocked: true,
    stats: { ATAQUE: 70, VELOCIDADE: 75, DEFESA: 65, TÉCNICA: 88, CARISMA: 92 },
    desc: 'Ás do espelho. Reflete o que treina, dobra o que recebe.',
    buff: 'vitalidade',
    accent: '#C084FC', accentDeep: '#6D1FB0', accentGlow: '#DCB8FF',
    lore: 'O ás do espelho. Cresceu numa academia 24h debaixo de um néon roxo — quando todos dormiam, ele treinava no reflexo. Hoje, cada gesto dele é estudado, refeito, refinado.',
    age: 28, origin: 'Distrito Mirror · Neo-Hollywood', style: 'Stage Athlete · Reflection Master',
    passives: [
      { icon: '🪞', text: '+12% XP em consistência (refletir hábitos)' },
      { icon: '🃏', text: '+10% XP em quests cumpridas sob pressão (último horário)' },
    ],
    signature: { name: 'Mirror Ace · 거울의 에이스', icon: '🪞',
      desc: 'Completar 2 quests no mesmo dia faz a próxima recompensa de XP duplicar. O espelho devolve em dobro.' },
    workouts: {
      'icons/workouts/peito.webp':      'icons/characters/joonki/peito.webp',
      'icons/workouts/dorsal.webp':     'icons/characters/joonki/costas.webp',
      'icons/workouts/abs.webp':        'icons/characters/joonki/abs.webp',
      'icons/workouts/pernas.webp':     'icons/characters/joonki/pernas.webp',
      'icons/workouts/caminhada.webp':  'icons/characters/joonki/caminhada.webp',
      'icons/workouts/calistenia.webp': 'icons/characters/joonki/calistenia.webp',
      'icons/workouts/bracos.webp':     'icons/characters/joonki/costas.webp',
      'icons/workouts/core.webp':       'icons/characters/joonki/abs.webp',
      'icons/workouts/ombros.webp':     'icons/characters/joonki/costas.webp',
      'icons/workouts/ombros2.webp':    'icons/characters/joonki/peito.webp',
    },
    workoutPositions: {
      'icons/characters/joonki/peito.webp':      'center 30%',
      'icons/characters/joonki/costas.webp':     'center 35%',
      'icons/characters/joonki/abs.webp':        'center 40%',
      'icons/characters/joonki/pernas.webp':     'center 50%',
      'icons/characters/joonki/caminhada.webp':  'center 30%',
      'icons/characters/joonki/calistenia.webp': 'center 50%',
    },
    bodyStates: {
      magrelo:  'icons/characters/joonki/bodies/magrelo.webp',
      lean:     'icons/characters/joonki/bodies/lean.webp',
      athletic: 'icons/characters/joonki/bodies/athletic.webp',
      bulked:   'icons/characters/joonki/bodies/bulked.webp',
      fat:      'icons/characters/joonki/bodies/fat.webp',
    },
  },
];
...
function seedSampleData() {
  ...
  const types = ['Upper B', 'Push', 'Caminhada', 'Core/Abs', 'Braços (bíceps + tríceps)'];
...
function modalDailyLog(dateISO = null) {
  ...
  const existing = state.dailyLogs.find((l) => l.date === today) || {
    date: today,
    training: { type: 'Upper B', done: false },
...
function viewWorkout() {
  ...
  const subtitles = {
    ...
    'Upper B':    'peito alto + ombros',
    'Upper completo': 'tronco inteiro',
    'Braços (bíceps + tríceps)': 'dia de braço',
  ...
  const icons = {
    '🆓 Treino livre': I.plus,
    'Push': I.flame, 'Upper B': I.fist, 'Core/Abs': I.skull,
    'Braços (bíceps + tríceps)': I.fist,
    'Caminhada': I.fighter,
  ...
  <section class="px-4 space-y-3">
    ...
    ${(() => {
      ...
      const GROUPS = {
        ...
        'UPPER / LOWER': ['Upper B', 'Push', 'Upper completo'],
        'POR FOCO': ['Braços (bíceps + tríceps)', 'Core/Abs'],
...
const WORKOUT_HERO_IMAGES = {
  ...
  'C · Pernas completo + Abs':  'icons/workouts/pernas.webp',
...
function detectSplit(exercises) {
  ...
  // Após dedup, todos os fallbacks que apontavam pra tipos removidos foram
  // redirecionados pros mantidos. ABC splits têm prioridade quando casa.
  if (has('biceps') && has('triceps') && !has('peito') && !has('dorsal')) {
    type = 'Braços (bíceps + tríceps)';
  } else if (has('peito') && has('triceps') && has('core')) {
    type = 'A · Peito + Tríceps + Abs';
  } else if (has('peito') && has('ombro') && has('triceps')) {
    type = 'Push';
  } else if (has('dorsal') && (has('ombro') || has('biceps')) && has('core')) {
    type = 'B · Costas + Ombros + Bíceps + Abs';
  } else if (has('quad') && has('post') && has('core')) {
    type = 'C · Pernas completo + Abs';
  } else if (has('core') && total === counts.core) {
    type = 'Core/Abs';
  } else if (has('cardio') && total === counts.cardio) {
    type = 'Caminhada';
  } else if (has('peito') || has('triceps')) {
    type = 'Push'; confidence = 0.5;
  } else if (has('dorsal') || has('biceps') || (has('ombro') && total === counts.ombro)) {
    type = 'Upper B'; confidence = 0.5;
  } else if (has('quad') || has('post')) {
    type = 'C · Pernas completo + Abs'; confidence = 0.5;
  } else {
...
function viewBody() {
  ...
  <!-- Banner Cutting: clique abre modal com dicas pra cutting saudável -->
  <section class="px-4 mt-3">
    <button id="open-cutting" class="cutting-banner w-full text-left">
      <div class="cutting-banner-img" style="background-image:url('icons/body/cutting.webp')"></div>
      <div class="cutting-banner-text">
        <div class="font-display text-[10px] uppercase tracking-[0.3em] text-white/70">CUTTING GUIDE</div>
        <div class="font-extrabold text-lg text-white drop-shadow-lg">Cutting saudável</div>
        <div class="text-[10px] text-white/80 leading-tight mt-0.5">Dicas pra perder gordura sem perder massa muscular</div>
      </div>
      <span class="text-white text-xl pr-3">→</span>
    </button>
  </section>
...
function modalCutting() {
  ...
  openModal(`
    ...
    <div class="p-4 overflow-y-auto space-y-4" style="max-height:55vh">

      <!-- Princípios -->
      <div>
        <div class="text-[10px] uppercase tracking-widest text-ink/55 dark:text-paper/55 mb-2">⚔ Princípios</div>
        <p class="text-[11px] text-ink/65 dark:text-paper/65 leading-snug mb-2">
          Cutting = déficit calórico controlado. Objetivo: <b>perder gordura sem perder músculo</b>.
          Mire em 0.5-1% do peso/semana. Mais rápido que isso, perde músculo junto.
        </p>
      </div>

      <!-- Calorias -->
      <div>
        <div class="text-[10px] uppercase tracking-widest text-ink/55 dark:text-paper/55 mb-2">📊 Calorias</div>
        <div class="space-y-1.5">
          ${[
            { icon: '🔢', text: 'Déficit de 300-500 kcal/dia (não mais). Calc TDEE em Config → Perfil físico.' },
            { icon: '📉', text: 'Pesar diário, média semanal. Se perdeu >1% peso/sem, sobe 100 kcal.' },
            { icon: '🍽️', text: 'Refeed 1x/sem (dia em manutenção) ajuda saúde mental e leptina.' },
          ].map(t => `
            <div class="q-card p-2.5 flex items-start gap-2 text-[12px]">
              <span class="text-base shrink-0">${t.icon}</span>
              <span class="leading-snug text-ink/85 dark:text-paper/85">${t.text}</span>
      ...
      <!-- Macros -->
      <div>
        <div class="text-[10px] uppercase tracking-widest text-ink/55 dark:text-paper/55 mb-2">🥩 Macros</div>
        <div class="space-y-1.5">
          ${[
            { icon: '🥩', text: 'Proteína: 1.8-2.2g/kg de peso. É o que MAIS importa pra preservar músculo.' },
            { icon: '🥑', text: 'Gordura: ~0.8-1g/kg (não corta gordura abaixo de 20% das kcal — afeta hormônios).' },
            { icon: '🍚', text: 'Carbo: o resto. Concentra perto dos treinos pra ter energia.' },
            { icon: '🥦', text: 'Fibras: ≥30g/dia. Saciedade + saúde intestinal.' },
          ].map(t => `
            <div class="q-card p-2.5 flex items-start gap-2 text-[12px]">
              <span class="text-base shrink-0">${t.icon}</span>
              <span class="leading-snug text-ink/85 dark:text-paper/85">${t.text}</span>
      ...
      <!-- Treino durante cutting -->
      <div>
        <div class="text-[10px] uppercase tracking-widest text-ink/55 dark:text-paper/55 mb-2">💪 Treino</div>
        <div class="space-y-1.5">
          ${[
            { icon: '🏋️', text: 'MANTÉM as cargas. Reduzir peso = sinal pro corpo "pode soltar músculo".' },
            { icon: '🔁', text: 'Volume igual ou levemente reduzido (10-15% menos series se cansaço bater).' },
            { icon: '🚶', text: 'Cardio: caminhada 7-10k passos/dia. HIIT 1-2x/sem. Não substitui força.' },
            { icon: '⏸️', text: 'Descanso entre séries pode aumentar — energia fica menor com déficit.' },
          ].map(t => `
            <div class="q-card p-2.5 flex items-start gap-2 text-[12px]">
              <span class="text-base shrink-0">${t.icon}</span>
              <span class="leading-snug text-ink/85 dark:text-paper/85">${t.text}</span>
      ...
      <!-- Recuperação -->
      <div>
        <div class="text-[10px] uppercase tracking-widest text-ink/55 dark:text-paper/55 mb-2">🛌 Recuperação</div>
        <div class="space-y-1.5">
          ${[
            { icon: '😴', text: 'Sono 7-9h é NÃO-NEGOCIÁVEL. Pouco sono = mais fome + menos músculo preservado.' },
            { icon: '💧', text: '35-40ml de água/kg de peso. Hidratação afeta apetite e performance.' },
            { icon: '🧂', text: 'Eletrólitos (sódio/potássio/magnésio) — cutting reduz retenção. Suplementar.' },
            { icon: '🧘', text: 'Stress controlado. Cortisol alto sabota cutting (retenção + fome).' },
          ].map(t => `
            <div class="q-card p-2.5 flex items-start gap-2 text-[12px]">
              <span class="text-base shrink-0">${t.icon}</span>
              <span class="leading-snug text-ink/85 dark:text-paper/85">${t.text}</span>
      ...
      <!-- Quando parar -->
      <div class="q-card p-3" style="border-left:3px solid #FFD341">
        <div class="text-[10px] uppercase tracking-widest font-bold mb-1" style="color:#FFD341">⚠️ Quando parar</div>
        <p class="text-[11px] text-ink/75 dark:text-paper/75 leading-snug">
          Cutting prolongado (>12 semanas) cai performance, libido e humor.
          Faz <b>diet break</b> de 1-2 semanas em manutenção a cada 8-10 semanas
...
function attachHandlers() {
  ...
  document.getElementById('open-cutting')?.addEventListener('click', modalCutting);
